...
void Replay::loadFrame(int frameIndex) {
  try {
    ...
    // Accessing data directly through u->data will no conserve offset generated by crop or operations that generate a subpart of original UMat but return full data.
